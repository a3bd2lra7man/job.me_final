...
class UpdateEducationFormScreen extends StatelessWidget {
  final Education education;

  static Widget init(
      {required ResumeProvider resumeProvider,
      required EducationsProvider educationsProvider,
      required Education education}) {
    educationsProvider.onStartUpdatingEducation(education);
    return MultiProvider(
      providers: [
        ChangeNotifierProvider.value(value: resumeProvider),
        ChangeNotifierProvider.value(value: educationsProvider),
      ],
      child: UpdateEducationFormScreen._(education: education),
    );
  }

  UpdateEducationFormScreen._({Key? key, required this.education}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PrimaryAppBar(
        title: context.translate('educations_edit'),
            ...
            : PrimaryButton(
                onPressed: () async {
                  if (_formKey.currentState != null && _formKey.currentState!.validate()) {
                    var isUpdated = await educationProvider.updateEducation(education.id!);
                    if (isUpdated == true) {
              ...
              children: [
                Expanded(
                  child: DatePicker(
                    ...
                    title: educationProvider.startDate!.toRawString(),
                  ),
                ),
                ...
                Expanded(
                  child: DatePicker(
                    ...
                    title: educationProvider.endDate!.toRawString(),
                  ),
                ),
              ],
            ),
