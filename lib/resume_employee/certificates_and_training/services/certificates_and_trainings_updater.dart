...
class CertificatesAndTrainingsUpdater {
  final API _api;
  String _sessionId = DateTime.now().millisecondsSinceEpoch.toString();
  bool _isLoading = false;

  CertificatesAndTrainingsUpdater() : _api = API();

  Future updateCertificateOrTraining(CertificateOrTraining certificateOrTraining) async {
    var url = CertificatesAndTrainingsUrls.updateCertificateUrls(certificateOrTraining.id!);
