...
import 'package:job_me/home/main/services/special_ads_jobs_fetcher.dart';

class SpecialJobProvider extends ChangeNotifier {
  BuildContext context;

  SpecialJobProvider(this.context);

  final SpecialAdsJobsFetcher _jobsFetcher = SpecialAdsJobsFetcher();
