...
class CompanyDepartmentDeleter {
  final API _api;
  String _sessionId = DateTime.now().millisecondsSinceEpoch.toString();
  bool _isLoading = false;

  CompanyDepartmentDeleter() : _api = API();

  Future deleteCompanyDepartment(int companyDepartmentId) async {
    var url = CompanyDepartmentsUrls.deleteCompanyDepartmentUrls(companyDepartmentId);
