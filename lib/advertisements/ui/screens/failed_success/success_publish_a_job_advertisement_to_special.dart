...
class SuccessfullyPublishedAJobAdvertisementToSpecialScreen extends StatelessWidget {
  const SuccessfullyPublishedAJobAdvertisementToSpecialScreen({Key? key}) : super(key: key);
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              context.translate('success_adding_advertisement_to_special'),
